    ...
    <section className="pb-20 pt-16 sm:pb-28 sm:pt-28">
      <div className="shell">
        ...
        <p className="lead mt-6 max-w-2xl">
          I build multi-agent LLM systems and natural-language interfaces over data, plus the
          web, mobile and desktop apps around them. I ship each one behind an eval harness and
          a hard cost cap, and the repos are public. Rerun any number on this page.
        </p>
