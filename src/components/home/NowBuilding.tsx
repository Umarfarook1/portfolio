...
const projects: Project[] = [
    {
        ...
        pitch: "Query BigQuery in natural language from Claude Desktop, Cursor, and Claude Code. Schema discovery, cost caps, query explanation, safety guardrails.",
        why: "MCP is an underserved lane. NL2SQL over warehouses is something I ship at work. First project.",
        stack: ["Python", "FastMCP", "BigQuery", "Claude", "Pydantic"],
    ...
    },
    {
        ...
        pitch: "Open benchmark of Claude, GPT, Gemini, Llama on real BigQuery-style schemas. Live leaderboard updated as new models drop.",
